...
The architecture is intended to grow beyond the current V0.2 feature set with profiles, Shortcuts/App Intents, richer diagnostics, HealthKit and richer environmental modules, and improved release/distribution workflows.
