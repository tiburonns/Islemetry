...
> **Release actual:** V0.4.1 (build 8). Añade una confirmación animada y háptica al botón **Aplicar a Live Activity**, manteniendo las automatizaciones de Atajos de V0.4.0.
