...
> **Current release:** V0.4.1 (build 8). Adds subtle animated and haptic confirmation to **Apply to Live Activity**, while keeping the Shortcuts automation support introduced in V0.4.0.
